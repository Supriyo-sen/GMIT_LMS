...
export default function Category() {
  ...
  return (
    <div className="min-h-screen bg-white p-6 text-black">
      <h1 className="text-3xl font-semibold mb-8 border-b pb-4">Manage Course Categories</h1>

      {/* ========== CREATE CATEGORY SECTION ========== */}
      <section className="mb-10">
        <h2 className="text-xl font-bold mb-4">➕ Create New Category</h2>
        <form className="bg-gray-100 p-6 rounded shadow-sm space-y-4 max-w-xl">
          <div>
        ...
        {selectedCategoryId ? (
          <div className="bg-blue-50 p-6 border border-blue-200 rounded shadow-sm space-y-3">
            <h3 className="text-lg font-semibold">
              Selected Category: <span className="text-blue-800">{selectedCategoryId}</span>
            </h3>
            <p><strong>Published Courses:</strong> 5</p>
            <p><strong>Top-Selling Courses:</strong> Fullstack Bootcamp, React Mastery</p>
            <p><strong>Other Popular Category:</strong> Data Science</p>
          </div>
        ) : (
          <p className="text-gray-500">Select a category from the list above to view details.</p>
        )}
      </section>
    </div>
  );
